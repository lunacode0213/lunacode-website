...
export const tenGodMapByDayStem = {
...
export const tenGodEarthMapByDayStem = {
...
export const hiddenStems = {
  '寅': [ { stem: '戊', pos: '여기' }, { stem: '丙', pos: '중기' }, { stem: '甲', pos: '본기' } ],
  '卯': [ { stem: '甲', pos: '여기' }, { stem: '乙', pos: '본기' } ],
  '辰': [ { stem: '乙', pos: '여기' }, { stem: '癸', pos: '중기' }, { stem: '戊', pos: '본기' } ],
  '巳': [ { stem: '戊', pos: '여기' }, { stem: '庚', pos: '중기' }, { stem: '丙', pos: '본기' } ],
  '午': [ { stem: '丙', pos: '여기' }, { stem: '己', pos: '중기' }, { stem: '丁', pos: '본기' } ],
  '未': [ { stem: '丁', pos: '여기' }, { stem: '乙', pos: '중기' }, { stem: '己', pos: '본기' } ],
  '申': [ { stem: '戊', pos: '여기' }, { stem: '壬', pos: '중기' }, { stem: '庚', pos: '본기' } ],
  '酉': [ { stem: '庚', pos: '여기' }, { stem: '辛', pos: '본기' } ],
  '戌': [ { stem: '辛', pos: '여기' }, { stem: '丁', pos: '중기' }, { stem: '戊', pos: '본기' } ],
  '亥': [ { stem: '戊', pos: '여기' }, { stem: '甲', pos: '중기' }, { stem: '壬', pos: '본기' } ],
  '子': [ { stem: '壬', pos: '여기' }, { stem: '癸', pos: '본기' } ],
  '丑': [ { stem: '癸', pos: '여기' }, { stem: '辛', pos: '중기' }, { stem: '己', pos: '본기' } ]
};
